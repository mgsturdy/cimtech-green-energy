...
export const homeContent = {
  ...
  industries: [
    { number: '01', title: 'Defense & Military', description: 'Mil-spec components, ruggedized assemblies, and ITAR-compliant manufacturing with full traceability.', href: '/industries', image: '', imageAlt: 'Precision manufacturing for defense' },
    { number: '02', title: 'Commercial & Industrial', description: 'Production scaling, supply chain reliability, and OEM partnerships for industrial applications.', href: '/industries', image: '', imageAlt: 'Commercial manufacturing' },
    { number: '03', title: 'Consumer Products', description: 'Rapid NPI, DFM feedback loops, and scaling from prototype to production runs.', href: '/industries', image: '', imageAlt: 'Consumer product manufacturing' },
    { number: '04', title: 'Clean Energy', description: 'Fuel cell stacks, electrolyzers, and hydrogen power systems. Home of our Rise Power sub-brand.', href: '/industries', image: '', imageAlt: 'Clean energy manufacturing' },
  ],

  capabilities: [
    { number: '01', title: 'Precision CNC Machining', description: '5-axis machining, CNC turning, grinding, and die & mold manufacturing. 20 CNC machines equipped with 4th & 5th axis capabilities for intricate shapes with micro-millimeter precision.', image: '' },
    { number: '02', title: 'Injection Molding', description: 'Low-volume and high-volume injection molding for plastic parts, offering precision, repeatability, and efficiency across prototyping and production.', image: '' },
    { number: '03', title: 'Fabrication & Welding', description: 'Laser cutting, waterjet cutting, sheet metal fabrication, and various welding techniques including MIG, TIG, and resistance welding.', image: '' },
    { number: '04', title: '3D Printing', description: 'FDM, SLA, and Metal 3D printing for rapid prototyping and production of complex geometries with exceptional precision.', image: '' },
    { number: '05', title: 'Assembly & Integration', description: 'Heat staking, autoclaving, and hydraulic press services for comprehensive turnkey assembly solutions across all industries.', image: '' },
    { number: '06', title: 'Quality Assurance', description: 'CMM inspection, ISO9001 and AS9100D certified, Controlled Goods Program compliant. Rigorous quality management throughout production.', image: '' },
  ] as AccordionItem[],
